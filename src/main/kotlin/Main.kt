fun main() {
    ...
    println("поиск количества повторяющихся значений в массиве: " + arrSearch.getStringToCountRepeatNumbers(arrayNumbers))
    ...
    println("сортировка массива сперва четные числа, потом нечетные по возрастанию: " + arrSort.getStringSortArrayFirstEvenThenOdd(arrayNumbers))
}
